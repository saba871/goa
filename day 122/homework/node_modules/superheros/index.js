...
// Super Hero API
// https://akabab.github.io/superhero-api/api/#powerstats

//All Super hero details
//https://akabab.github.io/superhero-api/api/glossary.html

let ids = [1, 2, 3, 4, 5, 6, 7, 8, 10,
    ...
    271, 273, 274, 275, 277, 278, 280,
    284, 285, 286, 287, 288, 289, 
    294, 296, 297, 298, 299, 300,
    303, 305, 306, 307, 308, 309, 310,
    311, 312, 313, 314, 315, 320,
    321, 322, 323, 325, 327, 330,
    332, 333, 334, 335, 336, 337, 338, 339, 340,
    341, 342, 343, 344, 345, 346, 347, 348, 349, 350,
    351, 352, 353, 354, 355, 356, 357, 358, 360,
    361, 364, 365, 367, 369, 370,
    371, 372, 373, 374, 375, 376, 379, 380,
    381, 382, 383, 384, 385, 386, 387, 388, 389, 390,
    391, 392, 393, 394, 395, 396, 397, 398, 400,
    401, 402, 403, 404, 405, 406, 407, 408, 409, 410,
    412, 413, 414, 415, 416, 418, 419, 
    421, 422, 423, 424, 425, 426, 427, 428, 429, 430,
    431, 432, 433, 435, 436, 437, 438, 439, 440,
    441, 442, 443, 444, 445, 448, 449, 450,
    451, 452, 454, 455, 456, 457, 458, 459, 460,
    461, 462, 463, 467, 469, 470,
    471, 472, 474, 475, 476, 477, 478, 479, 480,
    481, 483, 484, 485, 487, 488, 489, 490,
    491, 492, 493, 495, 496, 497, 498, 499]

// -------------------------------------------- (max - min + 1)) + min;    
let selectRandomId = Math.floor(Math.random() * (382 - 0 + 1)) + 0;

console.log(`the length of ids ${ids.length}`)
console.log(`The selected random number is ${selectRandomId}`);
console.log(`The selected id from random number is ${ids[selectRandomId]}`)


function gerenateSuperhero() {
    let name; 
    fetch(`https://akabab.github.io/superhero-api/api/id/${ids[selectRandomId]}.json`)
...
module.exports = gerenateSuperhero;
